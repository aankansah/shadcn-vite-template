...
const PolicyPreparation = () => {
  ...
  const [stepStatuses, setStepStatuses] = useState<Record<string, StepStatusType>>({});
  ...
  const processStep = async (stepId: string) => {
    ...
    try {
      ...
      return true;
       ...
       toast.error(error instanceof Error ? error.message : `Failed to complete ${stepId}. Please try again.`);
  ...
  const getStepStatusIcon = (stepId: string, stepIcon: React.ComponentType<{ className?: string }>) => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Invalid Flow</h2>
      ...
      <div className="py-8 h-full overflow-y-auto">
        <div className="max-w-4xl mx-auto space-y-6 pb-10">
            <Card className="bg-gradient text-white rounded-3xl">
                <CardHeader>
                <CardTitle className="text-2xl font-bold">{currentFlow.title}</CardTitle>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="w-32 h-2 bg-blue-500 rounded-full overflow-hidden">
                    <div 
            ...
            {currentFlow.steps.map((step, index) => (
                ...
                className={cn(
                    ...
                    stepStatuses[step.id] === StepStatus.IN_PROGRESS && "ring-2 ring-blue-500 shadow-lg",
                    stepStatuses[step.id] === StepStatus.COMPLETED && "bg-green-50 border-green-200",
                    stepStatuses[step.id] === StepStatus.ERROR && "bg-red-50 border-red-200"
                )}
                >
            ...
            <Card className="rounded-3xl bg-linear-to-r from-green-500 to-emerald-600 text-white">
                ...
                <h2 className="text-2xl font-bold mb-2">Policy Preparation Complete!</h2>
                <p className="text-green-100 mb-6">
                    Your policy has been successfully prepared and is ready for download.
                </p>
